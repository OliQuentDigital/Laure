...
<head>
    <meta charset="UTF-8">
    <title>Laure Feyssel - Photographe</title>
...
<body>
    ...
    <div id="ScrollPane">
        ...
        <div class="scr pane prt" style="background:#FF851B;" data-id="Welcome">
        ...
        <div class="scr pane prt an" style="background:#FF851B;" data-id="scr03">
            <div class="ct"><b>Fullscreen</b></div>
            <div class="scrolldown">Scroll down<br><i class="fa fa-arrow-down" aria-hidden="true"></i></div>
        </div>
        ...
        <div class="scr pane prt an" style="background:#FF851B;" data-id="scr04">
            <div class="ct"><b>Fullscreen</b></div>
        </div>
        ...
        <div class="scr pane prt an" style="background:#FF851B;" data-id="scr05">
            <div class="ct"><b>Fullscreen</b></div>
        </div>
        ...
        <div class="scr pane prt an" style="background:#FF851B;" data-id="Conclusion">
